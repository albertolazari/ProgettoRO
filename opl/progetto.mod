...
s.t. maxCorsiBoulder{g in G, o in O}: boulder[g,o] / (sum{i in I} b[i,g,o]) <= maxCorsiIstruttore;
s.t. maxCorsiLead{g in G, o in O}: lead[g,o] / (sum{i in I} l[i,g,o]) <= maxCorsiIstruttore;
